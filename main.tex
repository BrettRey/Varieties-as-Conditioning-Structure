...
\begin{itemize}
    \item \textbf{Situation} is token-level: it shifts rapidly~-- within a day, within a conversation, sometimes within an utterance. It's largely determined by external context.
