...
The overall pattern was conventional: socializing favoured [ɪn] (.72 Varbrul probability), meetings disfavoured it (.30). Most speakers shifted in the expected direction~-- more standard [ɪŋ] in the formal meeting context. But three speakers~-- Speed, Mick, and Waterson~-- reversed the pattern. In meetings, they used \emph{more} [ɪn], not less. For progressive verb forms (the cleanest comparison), Speed went from 95\% [ɪn] socializing to 82\% in meetings; Mick went from 67\% to 71\%; Waterson was categorical [ɪn] in meetings. Meanwhile, Mack~-- the contrast case~-- went from 73\% to 13\%.
