...
\begin{abstract}
What distinguishes register from dialect from discourse community? Not what they are, but what they're conditioned on. This paper argues that these aren't three kinds of thing but three dimensions of listener expectation, each conditioned on a different anchor: \textsc{situation} (the here-and-now), \textsc{ascription} (how the speaker is classified), or \textsc{identification} (whose norms the speaker orients to). The key distinction is between ascription and identification: ascription is what you are treated as; identification is who you orient to. Their divergence is a major locus of sociolinguistic agency, and the framework predicts that sociolinguistic variables should cluster at the points where S, A, and I make divergent predictions. Drawing on \posscite{wiese2023} account of communicative situations and \posscite{oconnor2019games} evolutionary game theory, I distinguish exogenous stabilizers (S/A/I themselves) from an endogenous stabilizer (coordination costs), and argue that varieties are homeostatic property cluster kinds: conventional enough to be coordination equilibria, structured enough to be projectible. A worked example using \posscite{kiesling1998} fraternity data on (ING) demonstrates that the framework captures distributional structure that standard factor-group analyses conflate.
\end{abstract}

\medskip
\noindent\textbf{Keywords:} sociolinguistic variation, register, dialect, discourse community, homeostatic property clusters, coordination games, Bayesian conditioning, listener expectation, indexicality, ascription, identification
...
This paper takes a different approach. Instead of defining variety types by their external correlates, I ask: what does a listener expect from a form~-- and what is that expectation conditioned on?
...
The key distinction is between \textsc{ascription} and \textsc{identification}. Ascription is what you are treated as: the categories others assign you. Identification is who you orient to: the norms you treat as yours.

More precisely: ascription is a classification process, not a metaphysical essence. Ascriptions can be contested, strategically managed, and revised over time, but they have material consequences because others condition their behaviour on them. This keeps \textsc{ascription} usable as an analyst's handle on socially consequential classification without presupposing that members of any descriptive category share a single stable identity with an essential link to language \citep[52]{drummond_schleef2016_identity}. Identification is the group whose norms you accept, whose approval you seek, whose usage you try to match. These can align (you orient to the community you're ascribed to) or diverge (you orient to a community you aspire to, have moved into, or are helping to build).
...
Social meaning isn't an arbitrary add-on. It's the informational flip-side of production conditioning. Speakers condition forms on context; listeners infer context from forms.
