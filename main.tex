...
Grammatical constraints are \term{tacit}, not explicit. Speakers follow them without being able to state them. You can reliably judge that \mention{*She is liking ice cream} sounds odd without knowing the first thing about stative verbs or the progressive. The constraint is internalized, not consulted.
